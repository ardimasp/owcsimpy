...
from ._subplots import subplot_class_factory, SubplotBase
...
from owcsimpy.geoutils.axes3dmod import Axes3DMod as Axes3D # <--- I add this
...
'polar', 'rectilinear', str}, optional
    ...
    @docstring.dedent_interpd
    def add_subplot(self, fig, *args, **kwargs):
        """
...
'polar', 'rectilinear', str}, optional
        ...
        *label* attribute has been exposed for this purpose: if you want
        ...
        if isinstance(args[0], SubplotBase):
            ...
            # a = subplot_class_factory(projection_class,fig=fig)(self,*args)
            # a = Axes3D(fig)
            # print(a)
            # print(type(a))
        self._axstack.add(key, a)
