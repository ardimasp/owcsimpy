...
Revision:
- focus on RWP and StochasticWalk
- output velocity
- time resolution 1 ms (find factor of 1000)
...
class RandomWaypoint(object):
    ...
    def __iter__(self):
        ...
        while True:
            ...
            positions += direction * velocity[:, np.newaxis] / 1000
...
class StochasticWalk(object):
    ...
    def __iter__(self):
        ...
        while True:
            ...
            xy += movement / 1000 # for 1 ms resolution (approximately)
            fl -= velocity / 1000 # for 1 ms resolution (approximately)
